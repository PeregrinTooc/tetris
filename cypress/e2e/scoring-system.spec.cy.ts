import { setTetrominoDropTimeInMiliseconds, addTetrominoO, addTetrominoI, doTimes, pressLeft, pressRight, pressHardDrop, pressDown, pressRotate } from "../support/testUtils";
...
describe("Scoring System", () => {
    ...
    it("should increase the score when a line is cleared", () => {
        ...
        cy.get("#score-board").invoke("text").then((scoreText) => {
